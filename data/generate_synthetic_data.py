...
if __name__ == "__main__":
    ...
    X_simple, y_simple = generate_simple_dataset(n_samples_per_class=50, random_state=42, noise=0.1)
    ...
    X_complex, y_complex = generate_complex_dataset(n_samples_per_class=50, random_state=42, noise=0.1)
